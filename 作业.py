...
print("30号	风衣 	96.98	335 	78")
print("总销售额:",(253.6*10+86.3*60+96.8*43+135.9*63+49.3*120+86.3*72+253.6*69+86.3*90+135.9*24+65.8*45+96.8*25+86.3*60+65.8*129+253.6*10+96.8*43+65.8*63+86.3*60+135.9*63+96.8*60+65.8*58+86.3*140+65.8*48+96.8*43+135.9*57+253.6*10+65.8*63+96.8*78))
print("平均每日销售数量：",(10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78)/30)
print("月销售总量：",(10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78))
print("羽绒服月销售占比:",((10+69+10+10+140)/1844),"%")
print("牛仔裤月收效占比",((60+72+35+90+60+60+140)/1844),"%")
print("风衣月销售占比",((43+25+43+60+43+78)/1844),"%")
print("皮草月销售占比",((63+24+63+57)/1844),"%")
print("T血月销售占比",((63+45+63+58+48+63)/1844),"%")
